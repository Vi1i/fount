...
// TODO(Vi1i): Shown below, but really we need this to be manageable in
//             any place that can determing state.
...
// systemd.exec(5).
// TODO(Vi1i): We need to log to correctly here, something like spdlog
//             might be useful as it allows us to set "sinks" and each
//             sink can have its configuration.
// TODO(Vi1i): Though we could also handle this our selves with some more
//             simplicty.
